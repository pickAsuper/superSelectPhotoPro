...
- (void)prepareUI {
    ...
    self.messageLabel2.backgroundColor = [UIColor redColor];
    ...
    self.messageLabel.frame = CGRectMake(centerX+10, centerY-10, 100, 40);
    self.messageLabel2.frame = CGRectMake(centerX+100, centerY-20, 100, 40);
...
- (void)setCurrentStatus:(XYPullRefreshStatus)currentStatus {
    ...
    if (currentStatus == Normal) {
        ...
        self.messageLabel2.text = @"正在刷新中 请稍等..";
...
- (UILabel *)messageLabel2 {
    if (_messageLabel2 == nil) {
        _messageLabel2 = [[UILabel alloc] init];
        _messageLabel2.font = [UIFont systemFontOfSize:14];
        _messageLabel2.textColor = [UIColor darkGrayColor];
        _messageLabel2.text = @"下拉刷新";
    }
